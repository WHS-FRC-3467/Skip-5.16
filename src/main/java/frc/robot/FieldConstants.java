...
public class FieldConstants {
    ...
    public static final List<Translation2d> ALLIANCE_ZONE =
        List.of(
    ...
    public static final List<Translation2d> NEUTRAL_ZONE =
        List.of(
    ...
    public static final List<Distance> TUNNEL_CENTER_Y = 
    List.of(
        Inches.of(24.97),
