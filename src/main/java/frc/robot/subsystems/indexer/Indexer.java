...
public class Indexer extends SubsystemBase {
    ...
    public double getLinearVelocity() {
        return io.getVelocity().in(RadiansPerSecond) * IndexerConstants.RADIUS.in(Meters);
    }
    ...
    public void setLinearVelocity(LinearVelocity velocity) {
        io.runVelocity( RadiansPerSecond.of(velocity.abs(MetersPerSecond)) , IndexerConstants.MAX_ACCELERATION, PIDSlot.SLOT_0);
    }
    ...
    public double getLinearPosition() {
        return io.getPosition().in(Radians) * (2 * Math.PI * IndexerConstants.RADIUS.in(Meters));
    }

    /**
     * Sets the current linear position of the indexer motor.
     */
    public void setLinearPosition(Angle position) {
        io.runPosition( position, PIDSlot.SLOT_0);
    }
}
