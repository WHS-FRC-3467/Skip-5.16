...
public class DriveConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs().withKP(60.0).withKS(3.18);
    ...
    private static final Distance kWheelRadius = Inches.of(1.782);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.488037109375);
